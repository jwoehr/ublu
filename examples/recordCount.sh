# recordCount.sh 
# Ublu 1.2.1+ gensh autogenerated this shell script Mon Dec 03 20:06:21 MST 2018 for jax using command:
...
function usage {
echo "recordCount.sh "
echo "Ublu gensh autogenerated this shell script Mon Dec 03 20:06:21 MST 2018 for jax."
