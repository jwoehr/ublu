# recordCount.sh 
# autogenerated Mon Dec 03 14:33:31 MST 2018 by jax using command:
# gensh -to recordCount.sh -path /opt/ublu/ublu.jar -optr s SYSNAME @sysname ${ System where test results reside }$ -opt z USESSL @usessl ${ T to use SSL }$ -optr u UPROF @uprof ${ User profile }$ -optr p PASSWD @passwd ${ Password }$ -optr c SCHEMA @schema ${ schema i.e library of file }$ -optr f FILENAME @filename ${ file to count rows of }$ -includepath /opt/ublu/examples/ ${ recordCount.sh }$ recordCount.ublu ${ recordCount ( @sysname @schema @filename @uprof @passwd @usessl ) }$

# Usage message
function usage {
echo "recordCount.sh "
echo "This shell script was autogenerated Mon Dec 03 14:33:31 MST 2018 by jax."
