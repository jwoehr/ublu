...
# autogenerated Fri Jul 21 00:15:48 MDT 2017 by jax using command:
...
echo "This shell script was autogenerated Fri Jul 21 00:15:48 MDT 2017 by jax."
echo "Usage: $0 [silent] [-h] [-X...] [-Dprop=val] -d DEFAULTS -w WORKDIR -o OUTFILE"
echo "	where"
