...
# Invocation
java -jar /opt/ublu/ublu.jar ${gensh_runtime_opts} include ${SILENT}/opt/api-java/examples/monitorJVMMem.ublu monitorIBMJVMMem \( @server @jmxport @password @critlevel @critmsg \) 
exit $?
