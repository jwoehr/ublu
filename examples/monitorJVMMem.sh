...
# autogenerated Wed Mar 09 19:24:06 MST 2016 by jax using command:
...
# Usage message
function usage { 
echo "monitorJVMMem.sh ... poll JVM memory via JMX and output SystemShepherd datapoints "
echo "This shell script was autogenerated Wed Mar 09 19:24:06 MST 2016 by jax."
...
# Invocation
java -jar /opt/ublu/ublu.jar ${gensh_runtime_opts} include ${SILENT}monitorJVMMem.ublu monitorJVMMem \( @server @jmxport @password @critlevel @critmsg \) 
exit $?
